...
if st.sidebar.button("Projects"):
    ...
    html_temp = """
    <a href="https://spoiler-prediction.herokuapp.com/">Demo</a>
    """
    st.markdown(html_temp, unsafe_allow_html=True)
    ...
    html_temp = """
    <a href="https://strea1.herokuapp.com/">Demo</a>
    """
    st.markdown(html_temp, unsafe_allow_html=True)
    ...
    html_temp = """
    <a href="https://zomatodash.herokuapp.com/">Demo</a>
    """
    st.markdown(html_temp, unsafe_allow_html=True)
    st.text("")
